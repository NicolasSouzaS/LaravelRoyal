...
<body style="background-color: white">
    ...
    <aside style="background: black" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "id="sidenav-main">


        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" style="color: #fff" aria-hidden="true" id="iconSidenav"></i>
            <a class="navbar-brand m-0" href="{{ url('/') }}" target="_blank">
                <img src="{{ asset('../images/iconroyalbarberBRANCO.png') }}" class="navbar-brand-img h-100"alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">RoyalBarber</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('compromissos') }}">
                        <div
                        ...
                        <span class="nav-link-text ms-1">Compromissos</span>
                    </a>
                </li>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  active" href="{{ url ('/dashboard/barbeiro') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ url('dashboard/barbeiro/compromisso') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ url('dashboard/barbeiro/perfil') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <script>
        ...
        function setActiveNavLink(event) {
            // Remove a classe "active" de todos os elementos com a classe "nav-link"
        ...
        // Adiciona um ouvinte de evento de clique a todos os elementos com a classe "nav-link"
        var navLinks = document.querySelectorAll('.nav-link');
        navLinks.forEach(function(navLink) {
...
<script>
    // Função para adicionar a classe "active" ao link de navegação correspondente à página atual
    function setActiveNavLink() {
        // Obtém o URL atual da página
        var currentUrl = window.location.href;

        // Obtém todos os elementos com a classe "nav-link"
        var navLinks = document.querySelectorAll('.nav-link');

        // Itera sobre os elementos para encontrar o link correspondente à página atual
        navLinks.forEach(function(navLink) {
            // Verifica se o href do elemento corresponde ao URL atual
    ...
    // Chama a função ao carregar a página para definir o link de navegação ativo
